...
public class Generation {
    ...
    private final int maxDepth;      // not used, kept for API match
    private final String dataFile;   // not used, kept for API match
    ...
    public void evalAll() {
        for (GPTree t : population) {
            // random fitness with 2-decimal resolution
    ...
    public void evolve() {
        // simple evolution so output changes across generations
